...
export const upscaleImageReplicate = async (image: string): Promise<string> => {
    ...
    // Unified Proxy for both Dev and Prod (handled by Vite or server.cjs)
    ...
    while (prediction.status !== 'succeeded' && prediction.status !== 'failed') {
        ...
        // HACK: Replicate returns "https://api.replicate.com/v1/..." in 'urls.get'.
        // We need to route this through our local proxy "/api/replicate/...".
